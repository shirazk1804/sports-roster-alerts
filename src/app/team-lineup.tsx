...
function MlbPlayerHeadshot({
    ...
    if (!playerId || failed) {
        return (
            <View
                style={
                    styles.playerHeadshotFallback
                }
            >
                <Text
                    style={
                        styles.playerHeadshotFallbackText
                    }
                >
                    {initials || "MLB"}
                </Text>
    ...
    const headshotUrl =
        ...
        + "image/upload/"
        + "w_120,h_140,c_fill,g_face/"
        + `v1/people/${playerId}/headshot/67/current`;

    return (
        <View
            style={styles.playerHeadshotContainer}
        >
            <Image
                source={{
                    uri: headshotUrl,
