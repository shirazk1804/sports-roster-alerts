...
public class NflInjuryScheduler {
        ...
        private final NflInjuryService nflInjuryService;

        private final NflInjuryChangeService nflInjuryChangeService;

        private final NflInjuryPracticeReportService nflInjuryPracticeReportService;
        ...
        public NflInjuryScheduler(
                ...
                this.nflInjuryService = nflInjuryService;

                this.nflInjuryChangeService = nflInjuryChangeService;

                this.nflInjuryPracticeReportService = nflInjuryPracticeReportService;
        ...
        public void checkNflInjuries() {
                 ...
                 */
                Map<String, String> providerTeamIdsByName = new HashMap<>();

                int staleSnapshotsRemoved = 0;

                for (String teamName : followersByTeam.keySet()) {
                        ...
                        try {
                                staleSnapshotsRemoved += nflInjuryChangeService
                                                .clearStaleSnapshots(
                                                                providerTeamId,
                                                                currentWeek);
                ...
                for (Map.Entry<String, List<FollowedTeam>> entry : followersByTeam.entrySet()) {
                        ...
                        String providerTeamId = providerTeamIdsByName.get(
                                        teamName);
                        ...
                        try {
                                 ...
                                 * create RosterEvents.
                                 */
                                List<RosterEvent> newEvents = nflInjuryChangeService
                                                .processTeamInjuries(
                                                                providerTeamId,
                                                                currentWeek,
                                                                injuries);
                ...
                System.out.println(
                                "NFL injury check complete. "
                                                ...
                                                + ". Injuries seen: "
                                                + totalInjuriesSeen
                                                + ". Practice reports captured: "
                                                + totalPracticeReportsCaptured
                                                + ". Stale snapshots removed: "
                                                + staleSnapshotsRemoved
                                                + ". New events: "
                                                + totalNewEvents
